...
const Home = () => {
  ...
  const categories = [
    { id: 'bags', name: 'Paketlar', icon: <ShoppingBag size={32} /> },
    { id: 'boxes', name: 'Qutilar', icon: <Package size={32} /> },
    { id: 'disposable', name: 'Idishlar', icon: <Coffee size={32} /> },
    { id: 'tape', name: 'Skotch', icon: <Scissors size={32} /> },
    { id: 'hygiene', name: 'Gigiena', icon: <Droplets size={32} /> }
  ];
